...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 06, 2022 lúc 02:50 PM
...
(36, '2022_11_06_134359_tbl_post', 6),
(37, '2022_11_06_134754_tbl_comment', 7);
...
(27, 16, 56, 57, 1, 1, 'Hợp Đồng Mua Bán Với Hợp Tác Xã Mỹ Lợi A Update', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 1, 0, 'thuonglai-update', '2022-11-05 06:54:59', '2022-11-05 07:16:30');
...
(18, 'Hợp đồng số 26 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 06:49:28', '2022-11-05 06:49:28'),
(19, 'Hợp đồng số 26 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 06:50:01', '2022-11-05 06:50:01'),
(20, 'Hợp đồng số 26 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 06:50:47', '2022-11-05 06:50:47'),
(21, 'Hợp đồng số 26 đã bị xóa bởi thương thương lái: Thương Lái A', 0, 57, '/hopdongmuaban', '2022-11-05 06:53:34', '2022-11-05 06:53:34'),
(22, 'Bạn vừa được tạo một hợp đồng với thương lái: Thương Lái A', 0, 57, '/hopdongmuaban', '2022-11-05 06:54:59', '2022-11-05 06:54:59'),
(23, 'Hợp đồng số 27 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 06:57:42', '2022-11-05 06:57:42'),
(24, 'Hợp đồng số 27 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 06:58:54', '2022-11-05 06:58:54'),
(25, 'Hợp đồng số 27 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 07:04:10', '2022-11-05 07:04:10'),
(26, 'Hợp đồng số 27 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 07:10:11', '2022-11-05 07:10:11'),
(27, 'Hợp đồng số 27 vừa được cập nhật bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-05 07:16:30', '2022-11-05 07:16:30'),
(28, 'Hợp đồng số 27 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-06 01:14:52', '2022-11-06 01:14:52'),
(29, 'Hợp đồng số 27 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-06 01:15:03', '2022-11-06 01:15:03'),
(30, 'Hợp đồng số 27 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-06 01:15:19', '2022-11-06 01:15:19'),
(31, 'Hợp đồng số 27 vừa được xác nhận bởi thương lái ', 0, 57, '/hopdongmuaban', '2022-11-06 01:15:55', '2022-11-06 01:15:55');
...
ALTER TABLE `tbl_comment`
  ...
  ADD KEY `tbl_comment_id_post_index` (`id_post`),
  ADD KEY `tbl_comment_id_user_index` (`id_user`);
...
ALTER TABLE `tbl_post`
  ...
  ADD KEY `tbl_post_id_user_index` (`id_user`);
...
--
ALTER TABLE `tbl_hopdongmuaban`
  MODIFY `id_hopdongmuaban` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_comment`
  ADD CONSTRAINT `tbl_comment_id_post_foreign` FOREIGN KEY (`id_post`) REFERENCES `tbl_post` (`id_post`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_comment_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `tbl_user` (`id_user`) ON DELETE CASCADE;
...
--
ALTER TABLE `tbl_post`
  ADD CONSTRAINT `tbl_post_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `tbl_user` (`id_user`) ON DELETE CASCADE;
